...
var itemsSchema = {
    note:{type : String, default :  null, format: '', typeString:'string',columnPosition:0, displayName:'Note', colWidth:180},
    date: {type: Date, default : null, format: 'mm/dd/yy', typeString:'date',columnPosition:1, displayName:'Date', colWidth:100},
    cost:{type : Number, default : null, format: '0,0.00', typeString:'number',columnPosition:2, displayName:'Cost/Rate', colWidth:160},
    qty:{type : Number, default : null, format: '0,0[.]0000', typeString:'number',columnPosition:3, displayName:'Quantity/Hours', colWidth:160},
    ...
    item:{type : String, default : null, format: '', typeString:'string',columnPosition:7, displayName:'Item/Service Desc.', colWidth:180},
