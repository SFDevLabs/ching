...
var itemsSchema = {
    note:{type : String, default :  null, format: '', typeString:'string',columnPosition:7, displayName:'Note', colWidth:150, printColWidth:80},
    ...
    qty:{type : Number, default : null, format: '0,0[.]0000', typeString:'number',columnPosition:2, displayName:'Quantity', colWidth:80, printColWidth:60},
    ...
    type:{type : String, default : 'Time', format: 'dropdown', dropdownOptions: ['Time','Item'], typeString:'string',columnPosition:6, displayName:'Time | Item', colWidth:60, printColWidth:40},
    item:{type : String, default : null, format: '', typeString:'string',columnPosition:0, displayName:'Description', colWidth:160, printColWidth:80},
