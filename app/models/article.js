...
var itemsSchema = {
    ...
    cost:{type : Number, default : null, format: '0,0.00', typeString:'number',columnPosition:1, displayName:'Unit Price', colWidth:160, printColWidth:60},
    qty:{type : Number, default : null, format: '0,0[.]0000', typeString:'number',columnPosition:2, displayName:'Quantity', colWidth:150, printColWidth:60},
    ...
    item:{type : String, default : null, format: '', typeString:'string',columnPosition:0, displayName:'Description', colWidth:180, printColWidth:80},
