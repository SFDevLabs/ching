...
exports.pdf= function(req, itemsSchema){
   ...
   doc.font('Helvetica', 15).fillColor('#787878 ').text('#'+this.formatInvoiceNumber(req.article.number))
   ...
   doc.addPage()
   doc.font('Helvetica', 18).text('Total: '+this.formatCurrency(req.article.total),{align: 'right'})
   return doc;
}